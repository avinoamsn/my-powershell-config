...
oh-my-posh init pwsh --config ~/pwsh10k.omp.json | Invoke-Expression # combination b/w https://github.com/Kudostoy0u/pwsh10k & https://github.com/u0hz/powerlevel10k-oh-my-posh
